...
EatIt 是一个面向日常做饭场景的响应式 Web 应用。项目收录了 152 道经过筛选的中式家常菜谱，覆盖水产、荤菜、素菜、主食、汤粥和早餐，提供分类均衡的菜品推荐、关键词搜索、分类筛选、食材用量、分段烹饪步骤和关联菜品推荐。
...
- 绝大多数菜品图片来自同一固定版本；51 道菜使用了逐张审核并随项目保存的 Wikimedia Commons 实拍图，不使用 AI 生成或 AI 放大图片。
